  ...
  return (
    ...
    >
      <div className="bg-[#1a1917]/90 backdrop-blur-sm border border-stone-500/30 rounded-xl px-5 py-4 min-w-[180px] max-w-[240px] transition-all group-hover:border-stone-400/50">
        <div className="flex items-center gap-2 mb-1">
          <div
            ...
            style={
              status === "published"
                ? { backgroundColor: "#34d399", boxShadow: "0 1px 2px rgba(52, 211, 153, 0.5)" }
                : { backgroundColor: "var(--accent)", boxShadow: `0 1px 2px rgba(var(--accent-rgb), 0.5)` }
            }
          />
      ...
      <Handle
        ...
        className="!bg-stone-500 !w-2.5 !h-2.5 !border-0 opacity-0 group-hover:opacity-100 transition-opacity"
      />
      <Handle
        type="target"
